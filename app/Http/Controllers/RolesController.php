...
class RolesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('role.index')->with('success', "The role <strong>$role->name</strong> has successfully been created.");
    }
    ...
    public function show($id)
    {
        ...
        try {
            ...
            return view('admin.role.roles_delete')->with($params);
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return redirect()->route('role.index')->with('success', "The Role <strong>$role->name</strong> has successfully been archived.");
        } catch (ModelNotFoundException $ex) {
            if ($ex instanceof ModelNotFoundException) {
                return response()->view('errors.' . '404');
            }
